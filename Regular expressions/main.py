...
"""Здравствуйте. Общий совет собирать данные в словарь, где ключи ФИ, а значения полные данные по записи.
При добавлении очередного элемента в словарь, проверяете наличия ключа ФИ. Если ключ уже есть, то объединяете данные по двум
записям."""
